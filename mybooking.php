...
<main class="relative pt-36 pb-24 overflow-hidden bg-[radial-gradient(circle_at_top_right,rgba(14,165,233,0.08),transparent_30%),radial-gradient(circle_at_bottom_left,rgba(59,130,246,0.05),transparent_35%)]">
                                ...
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="py-5 pr-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p class="font-black text-slate-900 text-base">حشو الأسنان وجذور</p>
                                                <p class="text-xs text-slate-400 mt-0.5">تكلفة تقريبية: 50$</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-5">
                                        <p class="font-bold text-slate-900">04 يونيو 2026</p>
                                        <p class="text-xs text-slate-500 mt-0.5">الساعة 04:30 مساءً</p>
                                    </td>
                                    <td class="py-5">
                                        <span class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-amber-50 text-amber-700 text-xs font-bold border border-amber-200/50">
                                            ● قيد الانتظار التأكيد
                                        </span>
                                    </td>
                                    <td class="py-5 text-center">
                                        <div class="flex items-center justify-center gap-2">
                                            <button class="px-4 py-2 text-xs font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-xl transition">
                                                تعديل
                                            </button>
                                            <button class="px-4 py-2 text-xs font-bold text-rose-600 bg-rose-50 hover:bg-rose-100 rounded-xl transition">
                                                إلغاء
                                            </button>
                                        </div>
                                    </td>
                                ...
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="py-5 pr-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <p class="font-black text-slate-900">تنظيف وتلميع الأسنان</p>
                                        </div>
                                    </td>
                                    <td class="py-5 text-slate-600">12 يناير 2026</td>
                                    <td class="py-5">
    ...
    <button onclick="openRatingModal()"
        class="px-4 py-2 rounded-xl bg-amber-50 text-amber-700 font-bold text-xs hover:bg-amber-100 transition">
        ⭐ تقييم الخدمة
    </button>
                                    </td>
                                </tr>
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="py-5 pr-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <p class="font-black text-slate-900">جلسة تبييض ليزر احترافي</p>
                                        </div>
                                    </td>
                                    <td class="py-5 text-slate-600">05 نوفمبر 2025</td>
                                    <td class="py-5">
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-xl bg-emerald-50 text-emerald-700 text-xs font-bold border border-emerald-200/40">
                                            ✓ مكتملة
                                        </span>
                                ...
                                <tr class="hover:bg-slate-50/50 transition">
                                    <td class="py-5 pr-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <p class="font-black text-slate-900">فحص دوري واستشارة</p>
                                        </div>
                                    </td>
                                    <td class="py-5 text-slate-600">18 أغسطس 2025</td>
                                    <td class="py-5">
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-xl bg-rose-50 text-rose-700 text-xs font-bold border border-rose-200/40">
                                            ✕ ملغي من المريض
                                        </span>
                                    </td>
                                    <td class="py-5 text-center">
